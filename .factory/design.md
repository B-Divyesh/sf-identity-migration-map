...
- The interactive demo follows one direct procedure: declare the identifiers, supply an excerpt, and inspect dependencies. Results show the source, line, owner, and required confirmation.
...
The 1200×630 social card and 180×180 touch icon were cropped from that original art on 2026-09-05. ImageMagick performed only resizing, cropping, and palette reduction. No outside asset was added.

Public headings use direct migration language rather than botanical labels. The botanical system remains a visual aid for dependency structure, not product lore.
